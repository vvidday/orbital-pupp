...
describe("Playing a game based on game link", () => {
    beforeAll(async () => {
        await page.goto("http://localhost:3000/cristianoxqc");
    });
    it("Game started from game link has correct behaviour", async () => {
        // Find and click on play button
        await delay(1000);
        const playButton = await page.waitForSelector("#play-btn");
